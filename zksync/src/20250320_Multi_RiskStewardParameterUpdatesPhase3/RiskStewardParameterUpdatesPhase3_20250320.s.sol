...
/**
 * @dev Deploy ZkSync
 * deploy-command: FOUNDRY_PROFILE=zksync make deploy-ledger contract=zksync/src/20250320_Multi_RiskStewardParameterUpdatesPhase3/RiskStewardParameterUpdatesPhase3_20250320.s.sol:DeployZkSync chain=zksync
 */
contract DeployZkSync is ZkSyncScript {
  function run() external broadcast {
    // deploy payloads
    address payload0 = address(
      new AaveV3ZkSync_RiskStewardParameterUpdatesPhase3_20250320{salt: 'aave'}()
    );
