...
contract AaveV3ZkSync_OnboardSUSDeUSDeAndWeETHToAaveV3OnZkSync_20250110 is AaveV3PayloadZkSync {
  ...
  address public constant USDe = 0x39Fe7a0DACcE31Bd90418e3e659fb0b5f0B3Db0d;
  uint256 public constant USDe_SEED_AMOUNT = 100e18;
  address public constant USDe_LM_ADMIN = 0x95Cbff6e45C499d45dd8627f3ce179057B5Fbfcc;
  ...
  function _postExecute() internal override {
    ...
    IERC20(USDe).forceApprove(address(AaveV3ZkSync.POOL), USDe_SEED_AMOUNT);
    AaveV3ZkSync.POOL.supply(USDe, USDe_SEED_AMOUNT, address(AaveV3ZkSync.COLLECTOR), 0);

    (address aUSDe, , ) = AaveV3ZkSync.AAVE_PROTOCOL_DATA_PROVIDER.getReserveTokensAddresses(USDe);
    IEmissionManager(AaveV3ZkSync.EMISSION_MANAGER).setEmissionAdmin(USDe, USDe_LM_ADMIN);
    IEmissionManager(AaveV3ZkSync.EMISSION_MANAGER).setEmissionAdmin(aUSDe, USDe_LM_ADMIN);
