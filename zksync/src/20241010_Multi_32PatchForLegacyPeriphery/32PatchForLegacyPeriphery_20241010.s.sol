...
/**
 * @dev Deploy ZkSync
 * deploy-command: make deploy-ledger contract=zksync/src/20241010_Multi_32PatchForLegacyPeriphery/32PatchForLegacyPeriphery_20241010.s.sol:DeployZkSync chain=zksync
