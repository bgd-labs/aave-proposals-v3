...
/**
 * @dev Test for AaveV3Arbitrum_WETHLTVRestorationAcrossV3Instances_20260511
  ...
  WETHLTVRestorationEmodeBaseTest
{
  ...
  function setUp() public {
    vm.createSelectFork({urlOrAlias: vm.rpcUrl('arbitrum'), blockNumber: 461648606});
    proposal = new AaveV3Arbitrum_WETHLTVRestorationAcrossV3Instances_20260511();
  }

  function test_defaultProposalExecution() public {
    defaultTest(
      'AaveV3Arbitrum_WETHLTVRestorationAcrossV3Instances_20260511',
      AaveV3Arbitrum.POOL,
      address(proposal)
    );
  }
