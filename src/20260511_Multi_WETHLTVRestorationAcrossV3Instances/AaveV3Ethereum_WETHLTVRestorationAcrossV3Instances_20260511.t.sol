...
/**
 * @dev Test for AaveV3Ethereum_WETHLTVRestorationAcrossV3Instances_20260511
 * command: FOUNDRY_PROFILE=test forge test --match-path=src/20260511_Multi_WETHLTVRestorationAcrossV3Instances/AaveV3Ethereum_WETHLTVRestorationAcrossV3Instances_20260511.t.sol -vv
 */
contract AaveV3Ethereum_WETHLTVRestorationAcrossV3Instances_20260511_Test is
  WETHLTVRestorationEmodeBaseTest
{
  ...
  AaveV3Ethereum_WETHLTVRestorationAcrossV3Instances_20260511 internal proposal;

  function setUp() public {
    vm.createSelectFork({urlOrAlias: vm.rpcUrl('mainnet'), blockNumber: 25070702});
    proposal = new AaveV3Ethereum_WETHLTVRestorationAcrossV3Instances_20260511();
  }

  function test_defaultProposalExecution() public {
    defaultTest(
      'AaveV3Ethereum_WETHLTVRestorationAcrossV3Instances_20260511',
      AaveV3Ethereum.POOL,
      address(proposal)
    );
  }
