...
contract AaveV3Monad_AaveV3MonadActivation_20260623 is AaveV3PayloadMonad {
  ...
  uint256 public constant mUSD_SEED_AMOUNT = 1e6;
  ...
  uint256 public constant cbBTC_SEED_AMOUNT = 1e8;
  ...
  uint256 public constant syrupUSDC_SEED_AMOUNT = 1e6;
  ...
  function newListings() public pure override returns (IAaveV3ConfigEngine.Listing[] memory) {
    IAaveV3ConfigEngine.Listing[] memory listings = new IAaveV3ConfigEngine.Listing[](12);
    ...
    listings[11] = IAaveV3ConfigEngine.Listing({
      asset: sUSDe,
      assetSymbol: 'sUSDe',
    ...
    returns (IAaveV3ConfigEngine.EModeCategoryCreation[] memory)
  {
    ...
    address[] memory borrowableAssets_Maple_syrupUSDC = new address[](5);
    ...
    borrowableAssets_Maple_syrupUSDC[2] = GHO;
    borrowableAssets_Maple_syrupUSDC[3] = mUSD;
    borrowableAssets_Maple_syrupUSDC[4] = AUSD;
    ...
    address[] memory borrowableAssets_Liquid_Leverage = new address[](4);
    ...
    borrowableAssets_Liquid_Leverage[2] = GHO;
    borrowableAssets_Liquid_Leverage[3] = AUSD;
