...
/**
 * @dev Deploy Ethereum
 * deploy-command: make deploy-ledger contract=src/20240115_Multi_HarmonizeUSDTRiskParametersOnAaveV3Markets/HarmonizeUSDTRiskParametersOnAaveV3Markets_20240115.s.sol:DeployEthereum chain=mainnet
 * verify-command: npx catapulta-verify -b broadcast/HarmonizeUSDTRiskParametersOnAaveV3Markets_20240115.s.sol/1/run-latest.json
 */
contract DeployEthereum is EthereumScript {
  function run() external broadcast {
    // deploy payloads
    address payload0 = GovV3Helpers.deployDeterministic(
      type(AaveV3Ethereum_HarmonizeUSDTRiskParametersOnAaveV3Markets_20240115).creationCode
    );
...
/**
 * @dev Deploy Polygon
 * deploy-command: make deploy-ledger contract=src/20240115_Multi_HarmonizeUSDTRiskParametersOnAaveV3Markets/HarmonizeUSDTRiskParametersOnAaveV3Markets_20240115.s.sol:DeployPolygon chain=polygon
 * verify-command: npx catapulta-verify -b broadcast/HarmonizeUSDTRiskParametersOnAaveV3Markets_20240115.s.sol/137/run-latest.json
 */
contract DeployPolygon is PolygonScript {
  function run() external broadcast {
    // deploy payloads
    address payload0 = GovV3Helpers.deployDeterministic(
      type(AaveV3Polygon_HarmonizeUSDTRiskParametersOnAaveV3Markets_20240115).creationCode
    );
 ...
 * deploy-command: make deploy-ledger contract=src/20240115_Multi_HarmonizeUSDTRiskParametersOnAaveV3Markets/HarmonizeUSDTRiskParametersOnAaveV3Markets_20240115.s.sol:DeployAvalanche chain=avalanche
 * verify-command: npx catapulta-verify -b broadcast/HarmonizeUSDTRiskParametersOnAaveV3Markets_20240115.s.sol/43114/run-latest.json
 */
contract DeployAvalanche is AvalancheScript {
  function run() external broadcast {
    // deploy payloads
    address payload0 = GovV3Helpers.deployDeterministic(
      type(AaveV3Avalanche_HarmonizeUSDTRiskParametersOnAaveV3Markets_20240115).creationCode
    );
...
/**
 * @dev Deploy Optimism
 * deploy-command: make deploy-ledger contract=src/20240115_Multi_HarmonizeUSDTRiskParametersOnAaveV3Markets/HarmonizeUSDTRiskParametersOnAaveV3Markets_20240115.s.sol:DeployOptimism chain=optimism
 * verify-command: npx catapulta-verify -b broadcast/HarmonizeUSDTRiskParametersOnAaveV3Markets_20240115.s.sol/10/run-latest.json
 */
contract DeployOptimism is OptimismScript {
  function run() external broadcast {
    // deploy payloads
    address payload0 = GovV3Helpers.deployDeterministic(
      type(AaveV3Optimism_HarmonizeUSDTRiskParametersOnAaveV3Markets_20240115).creationCode
    );
...
/**
 * @dev Deploy Arbitrum
 * deploy-command: make deploy-ledger contract=src/20240115_Multi_HarmonizeUSDTRiskParametersOnAaveV3Markets/HarmonizeUSDTRiskParametersOnAaveV3Markets_20240115.s.sol:DeployArbitrum chain=arbitrum
 * verify-command: npx catapulta-verify -b broadcast/HarmonizeUSDTRiskParametersOnAaveV3Markets_20240115.s.sol/42161/run-latest.json
 */
contract DeployArbitrum is ArbitrumScript {
  function run() external broadcast {
    // deploy payloads
    address payload0 = GovV3Helpers.deployDeterministic(
      type(AaveV3Arbitrum_HarmonizeUSDTRiskParametersOnAaveV3Markets_20240115).creationCode
    );
...
/**
 * @dev Deploy Metis
 * deploy-command: make deploy-ledger contract=src/20240115_Multi_HarmonizeUSDTRiskParametersOnAaveV3Markets/HarmonizeUSDTRiskParametersOnAaveV3Markets_20240115.s.sol:DeployMetis chain=metis
  ...
  function run() external {
    ...
    GovV3Helpers.createProposal(
      ...
      GovV3Helpers.ipfsHashFile(
        vm,
        'src/20240115_Multi_HarmonizeUSDTRiskParametersOnAaveV3Markets/HarmonizeUSDTRiskParametersOnAaveV3Markets.md'
      )
    );
  }
}
