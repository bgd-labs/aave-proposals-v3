...
/**
 * @dev Test for AaveV2Avalanche_RFAndSlope1UpdatesLateOctober_20241023
 * command: FOUNDRY_PROFILE=avalanche forge test --match-path=src/20241023_Multi_RFAndSlope1UpdatesLateOctober/AaveV2Avalanche_RFAndSlope1UpdatesLateOctober_20241023.t.sol -vv
 */
contract AaveV2Avalanche_RFAndSlope1UpdatesLateOctober_20241023_Test is ProtocolV2TestBase {
  AaveV2Avalanche_RFAndSlope1UpdatesLateOctober_20241023 internal proposal;
  ...
  function setUp() public {
    vm.createSelectFork(vm.rpcUrl('avalanche'), 52153336);
    proposal = new AaveV2Avalanche_RFAndSlope1UpdatesLateOctober_20241023();
  }
  ...
  function test_defaultProposalExecution() public {
    (ReserveConfig[] memory allConfigsBefore, ReserveConfig[] memory allConfigsAfter) = defaultTest(
      'AaveV2Avalanche_RFAndSlope1UpdatesLateOctober_20241023',
