 ...
 * - Discussion: https://governance.aave.com/t/arfc-avalanche-v2-reserve-factor-adjustment/17040/14
 */
contract AaveV2Avalanche_RFAndSlope1UpdatesLateOctober_20241023 is IProposalGenericExecutor {
  ILendingPoolConfigurator public constant POOL_CONFIGURATOR =
    ILendingPoolConfigurator(AaveV2Avalanche.POOL_CONFIGURATOR);

  uint256 public constant DAIe_RF = 85_00;
  uint256 public constant USDCe_RF = 85_00;
  uint256 public constant USDTe_RF = 85_00;
  uint256 public constant WAVAX_RF = 85_00;
  uint256 public constant WBTCe_RF = 90_00;
  uint256 public constant WETHe_RF = 85_00;
