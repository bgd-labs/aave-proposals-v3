...
/**
 * @dev Test for AaveV2Ethereum_RFAndSlope1UpdatesLateOctober_20241023
 * command: FOUNDRY_PROFILE=mainnet forge test --match-path=src/20241023_Multi_RFAndSlope1UpdatesLateOctober/AaveV2Ethereum_RFAndSlope1UpdatesLateOctober_20241023.t.sol -vv
 */
contract AaveV2Ethereum_RFAndSlope1UpdatesLateOctober_20241023_Test is ProtocolV2TestBase {
  AaveV2Ethereum_RFAndSlope1UpdatesLateOctober_20241023 internal proposal;
  ...
  function setUp() public {
    vm.createSelectFork(vm.rpcUrl('mainnet'), 21029785);
    proposal = new AaveV2Ethereum_RFAndSlope1UpdatesLateOctober_20241023();
  }
  ...
  function test_defaultProposalExecution() public {
    (ReserveConfig[] memory allConfigsBefore, ReserveConfig[] memory allConfigsAfter) = defaultTest(
      'AaveV2Ethereum_RFAndSlope1UpdatesLateOctober_20241023',
      AaveV2Ethereum.POOL,
      address(proposal)
    );
