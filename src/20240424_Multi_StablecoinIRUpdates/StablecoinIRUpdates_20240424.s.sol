...
/**
 * @dev Deploy Ethereum
 * deploy-command: make deploy-ledger contract=src/20240424_Multi_StablecoinIRUpdates/StablecoinIRUpdates_20240424.s.sol:DeployEthereum chain=mainnet
 * verify-command: npx catapulta-verify -b broadcast/StablecoinIRUpdates_20240424.s.sol/1/run-latest.json
 */
contract DeployEthereum is EthereumScript {
  function run() external broadcast {
    // deploy payloads
    address payload0 = GovV3Helpers.deployDeterministic(
      type(AaveV2Ethereum_StablecoinIRUpdates_20240424).creationCode
    );
    address payload1 = GovV3Helpers.deployDeterministic(
      type(AaveV3Ethereum_StablecoinIRUpdates_20240424).creationCode
    );
...
/**
 * @dev Deploy Gnosis
 * deploy-command: make deploy-ledger contract=src/20240424_Multi_StablecoinIRUpdates/StablecoinIRUpdates_20240424.s.sol:DeployGnosis chain=gnosis
 * verify-command: npx catapulta-verify -b broadcast/StablecoinIRUpdates_20240424.s.sol/100/run-latest.json
 */
contract DeployGnosis is GnosisScript {
  function run() external broadcast {
    // deploy payloads
    address payload0 = GovV3Helpers.deployDeterministic(
      type(AaveV3Gnosis_StablecoinIRUpdates_20240424).creationCode
    );
...
/**
 * @dev Deploy Scroll
 * deploy-command: make deploy-ledger contract=src/20240424_Multi_StablecoinIRUpdates/StablecoinIRUpdates_20240424.s.sol:DeployScroll chain=scroll
 * verify-command: npx catapulta-verify -b broadcast/StablecoinIRUpdates_20240424.s.sol/534352/run-latest.json
 */
contract DeployScroll is ScrollScript {
  function run() external broadcast {
    // deploy payloads
    address payload0 = GovV3Helpers.deployDeterministic(
      type(AaveV3Scroll_StablecoinIRUpdates_20240424).creationCode
    );
...
/**
 * @dev Deploy BNB
 * deploy-command: make deploy-ledger contract=src/20240424_Multi_StablecoinIRUpdates/StablecoinIRUpdates_20240424.s.sol:DeployBNB chain=bnb
 * verify-command: npx catapulta-verify -b broadcast/StablecoinIRUpdates_20240424.s.sol/56/run-latest.json
 */
contract DeployBNB is BNBScript {
  function run() external broadcast {
    // deploy payloads
    address payload0 = GovV3Helpers.deployDeterministic(
      type(AaveV3BNB_StablecoinIRUpdates_20240424).creationCode
    );
