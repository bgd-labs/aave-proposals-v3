...
uint256 constant ARBITRUM_BLOCK_NUMBER = 381605600;

contract Arbitrum_Plasma_AaveV3GHOLane_20250921_Test_PreExecution is
  AaveV3GHORemoteLaneTest_PreExecution
{
  ...
  function _deployAaveV3GHOLaneProposal() internal virtual override returns (AaveV3GHOLane) {
    return new Arbitrum_Plasma_AaveV3GHOLane_20250921();
  }

  function test_defaultProposalExecution() public virtual {
    defaultTest('Arbitrum_Plasma_AaveV3GHOLane_20250921', AaveV3Arbitrum.POOL, address(proposal));
  }
...
contract Arbitrum_Plasma_AaveV3GHOLane_20250921_Test_PostExecution is
