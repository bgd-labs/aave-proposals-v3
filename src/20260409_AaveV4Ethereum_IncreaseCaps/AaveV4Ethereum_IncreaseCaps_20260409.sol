...
contract AaveV4Ethereum_IncreaseCaps_20260409 is AaveV4Payload {
    ...
    returns (IAaveV4ConfigEngine.SpokeConfigUpdate[] memory)
  {
    ...
    updates[i++] = _capUpdate(CORE, address(AaveV4EthereumSpokes.ETHERFI_ESPOKE), AaveV4EthereumAssets.WETH_UNDERLYING,                    KC,        1_600);
    updates[i++] = _capUpdate(CORE, address(AaveV4EthereumSpokes.ETHERFI_ESPOKE), AaveV4EthereumAssets.weETH_UNDERLYING,                   1_500,     KC);
    ...
    updates[i++] = _capUpdate(CORE, address(AaveV4EthereumSpokes.KELP_ESPOKE),    AaveV4EthereumAssets.WETH_UNDERLYING,                    KC,        1_600);
    updates[i++] = _capUpdate(CORE, address(AaveV4EthereumSpokes.KELP_ESPOKE),    AaveV4EthereumAssets.rsETH_UNDERLYING,                   1_500,     KC);
    updates[i++] = _capUpdate(CORE, address(AaveV4EthereumSpokes.LIDO_ESPOKE),    AaveV4EthereumAssets.WETH_UNDERLYING,                    KC,        1_600);
    updates[i++] = _capUpdate(CORE, address(AaveV4EthereumSpokes.LIDO_ESPOKE),    AaveV4EthereumAssets.wstETH_UNDERLYING,                  1_500,     KC);
