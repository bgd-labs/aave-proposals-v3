...
contract DeployEthereum is EthereumScript {
  function run() external broadcast {
    ...
    address payload0 = GovV3Helpers.deployDeterministic(
      type(AaveV3EthereumLido_SetACIAsEmissionManagerForWstETH_20240923).creationCode
    );
...
/**
 * @dev Create Proposal
 * command: make deploy-ledger contract=src/20240923_AaveV3EthereumLido_SetACIAsEmissionManagerForWstETH/SetACIAsEmissionManagerForWstETH_20240923.s.sol:CreateProposal chain=mainnet
 */
  ...
  function run() external {
    ...
    GovV3Helpers.createProposal(
      ...
      GovV3Helpers.ipfsHashFile(
        vm,
        'src/20240923_AaveV3EthereumLido_SetACIAsEmissionManagerForWstETH/SetACIAsEmissionManagerForWstETH.md'
      )
    );
  }
}
