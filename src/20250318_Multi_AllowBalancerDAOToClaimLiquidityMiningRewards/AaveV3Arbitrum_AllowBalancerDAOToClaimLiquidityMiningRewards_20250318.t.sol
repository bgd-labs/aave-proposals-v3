...
/**
 * @dev Test for AaveV3Arbitrum_AllowBalancerDAOToClaimLiquidityMiningRewards_20250318
 * command: FOUNDRY_PROFILE=arbitrum forge test --match-path=src/20250318_Multi_AllowBalancerDAOToClaimLiquidityMiningRewards/AaveV3Arbitrum_AllowBalancerDAOToClaimLiquidityMiningRewards_20250318.t.sol -vv
 */
contract AaveV3Arbitrum_AllowBalancerDAOToClaimLiquidityMiningRewards_20250318_Test is
  ProtocolV3TestBase
{
  ...
  function setUp() public {
    vm.createSelectFork(vm.rpcUrl('arbitrum'), 317036630);
  ...
  function test_defaultProposalExecution() public {
    defaultTest(
      'AaveV3Arbitrum_AllowBalancerDAOToClaimLiquidityMiningRewards_20250318',
      AaveV3Arbitrum.POOL,
      address(proposal)
    );
