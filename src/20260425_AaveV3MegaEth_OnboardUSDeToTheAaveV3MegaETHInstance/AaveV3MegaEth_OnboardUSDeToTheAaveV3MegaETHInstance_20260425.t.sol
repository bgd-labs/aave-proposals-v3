...
/**
 * @dev Test for AaveV3MegaEth_OnboardUSDeToTheAaveV3MegaETHInstance_20260425
 * command: FOUNDRY_PROFILE=test forge test --match-path=src/20260425_AaveV3MegaEth_OnboardUSDeToTheAaveV3MegaETHInstance/AaveV3MegaEth_OnboardUSDeToTheAaveV3MegaETHInstance_20260425.t.sol -vv
 */
contract AaveV3MegaEth_OnboardUSDeToTheAaveV3MegaETHInstance_20260425_Test is ProtocolV3TestBase {
  AaveV3MegaEth_OnboardUSDeToTheAaveV3MegaETHInstance_20260425 internal proposal;

  function setUp() public {
    vm.createSelectFork(vm.rpcUrl('megaeth'), 14312492);
  ...
  function test_defaultProposalExecution() public {
    defaultTest(
      'AaveV3MegaEth_OnboardUSDeToTheAaveV3MegaETHInstance_20260425',
      AaveV3MegaEth.POOL,
      address(proposal)
    );
  }
