 ...
 */
contract AaveV3MegaEth_OnboardUSDeToTheAaveV3MegaETHInstance_20260425 is AaveV3PayloadMegaEth {
    ...
    returns (IAaveV3ConfigEngine.EModeCategoryCreation[] memory)
  {
    ...
    collaterals[0] = USDe;
    borrowables[0] = AaveV3MegaEthAssets.USDT0_UNDERLYING;
    borrowables[1] = AaveV3MegaEthAssets.USDm_UNDERLYING;
