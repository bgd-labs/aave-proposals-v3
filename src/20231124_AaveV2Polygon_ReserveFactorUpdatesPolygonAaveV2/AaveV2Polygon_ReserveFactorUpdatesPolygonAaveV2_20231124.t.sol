...
contract AaveV2Polygon_ReserveFactorUpdatesPolygonAaveV2_20231124_Test is ProtocolV2TestBase {
  ...
  function setUp() public {
    ...
    proposal = AaveV2Polygon_ReserveFactorUpdatesPolygonAaveV2_20231124(
      0x7f88576D829C82E7f3BDDEFc67A143E83AC1d615
    );
  }
  ...
  function test_defaultProposalExecution() public {
    ...
    assetChanges[0] = Changes({asset: AaveV2PolygonAssets.DAI_UNDERLYING, reserveFactor: 51_00});
    assetChanges[1] = Changes({asset: AaveV2PolygonAssets.USDC_UNDERLYING, reserveFactor: 53_00});
    assetChanges[2] = Changes({asset: AaveV2PolygonAssets.USDT_UNDERLYING, reserveFactor: 52_00});
    assetChanges[3] = Changes({asset: AaveV2PolygonAssets.WBTC_UNDERLYING, reserveFactor: 85_00});
    assetChanges[4] = Changes({asset: AaveV2PolygonAssets.WETH_UNDERLYING, reserveFactor: 75_00});
    assetChanges[5] = Changes({asset: AaveV2PolygonAssets.WMATIC_UNDERLYING, reserveFactor: 71_00});
    assetChanges[6] = Changes({asset: AaveV2PolygonAssets.BAL_UNDERLYING, reserveFactor: 99_00});
