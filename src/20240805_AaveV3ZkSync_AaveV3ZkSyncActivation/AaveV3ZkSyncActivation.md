...
**\* For extra caution and security, the zkSync instance is being activated with low supply and borrow caps to allow for extensive internal testing for a few days, after which the caps will be raised according to the ones mentioned on the table by the guardian after being communicated on the governance forum.**
