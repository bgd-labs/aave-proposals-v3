...
- Improved the coverage on the tests, adding some more fork test scenarios covering the issue of bitmap corruption and verifying that the zksolc `1.5.3` fixes the issue. The [tests](https://github.com/bgd-labs/aave-v3-origin/tree/feat/zksync-tests) could be found here.
