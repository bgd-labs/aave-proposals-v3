...
contract AaveV3Polygon_EnhancingMarketGranularityInAave36Part2_20260127 is AaveV3PayloadPolygon {
    ...
    returns (IAaveV3ConfigEngine.EModeCategoryCreation[] memory)
  {
    ...
    address[] memory collateralAssets_AAVE__USDCn_USDT = new address[](1);
    address[] memory borrowableAssets_AAVE__USDCn_USDT = new address[](2);

    collateralAssets_AAVE__USDCn_USDT[0] = AaveV3PolygonAssets.AAVE_UNDERLYING;
    borrowableAssets_AAVE__USDCn_USDT[0] = AaveV3PolygonAssets.USDT0_UNDERLYING;
    borrowableAssets_AAVE__USDCn_USDT[1] = AaveV3PolygonAssets.USDCn_UNDERLYING;
    ...
    eModeCreations[0] = IAaveV3ConfigEngine.EModeCategoryCreation({
      ...
      collaterals: collateralAssets_AAVE__USDCn_USDT,
      borrowables: borrowableAssets_AAVE__USDCn_USDT
    });
