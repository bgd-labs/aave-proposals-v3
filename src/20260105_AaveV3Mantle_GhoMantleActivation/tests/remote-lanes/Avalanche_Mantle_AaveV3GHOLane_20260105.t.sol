...
uint256 constant AVALANCHE_BLOCK_NUMBER = 75732940;

contract Avalanche_Mantle_AaveV3GHOLane_20260105_Test_PreExecution is
  AaveV3GHORemoteLaneTest_PreExecution
{
  ...
  function _deployAaveV3GHOLaneProposal() internal virtual override returns (AaveV3GHOLane) {
    return new Avalanche_Mantle_AaveV3GHOLane_20260105();
  }

  function test_defaultProposalExecution() public virtual {
    defaultTest('Avalanche_Mantle_AaveV3GHOLane_20260105', AaveV3Avalanche.POOL, address(proposal));
  }
...
contract Avalanche_Mantle_AaveV3GHOLane_20260105_Test_PostExecution is
