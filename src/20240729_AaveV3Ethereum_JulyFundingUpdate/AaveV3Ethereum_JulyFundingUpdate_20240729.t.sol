...
contract AaveV3Ethereum_JulyFundingUpdate_20240729_Test is ProtocolV3TestBase {
  ...
  function test_swapEvents() public {
    ...
    emit SwapRequested(
      ...
      112014478259269445050414, // Hardcoded as dynamic
    ...
    emit SwapRequested(
      ...
      proposal.USDT_FEED(),
      proposal.GHO_USD_FEED(),
      499999999999, // Hardcoded as dynamic
      address(AaveV3Ethereum.COLLECTOR),
      50
    );
    ...
    emit SwapRequested(
      ...
      proposal.FRAX_FEED(),
      proposal.GHO_USD_FEED(),
      31935428199756049088619, // Hardcoded as dynamic
      address(AaveV3Ethereum.COLLECTOR),
      100
    );
    ...
    emit SwapRequested(
      ...
      proposal.DPI_FEED(),
      proposal.GHO_USD_FEED(),
      133444159197713527567, // Hardcoded as dynamic
      address(AaveV3Ethereum.COLLECTOR),
      500
    );
