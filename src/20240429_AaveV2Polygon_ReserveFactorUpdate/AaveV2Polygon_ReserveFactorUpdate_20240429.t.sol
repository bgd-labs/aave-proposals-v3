...
/**
 * @dev Test for AaveV2Polygon_ReserveFactorUpdate_20240429
 * command: make test-contract filter=AaveV2Polygon_ReserveFactorUpdate_20240429
 */
contract AaveV2Polygon_ReserveFactorUpdate_20240429_Test is ProtocolV2TestBase {
  struct Changes {
    address asset;
    uint256 reserveFactor;
  }
  AaveV2Polygon_ReserveFactorUpdate_20240429 internal proposal;

  function setUp() public {
    vm.createSelectFork(vm.rpcUrl('polygon'), 56380847);
    proposal = new AaveV2Polygon_ReserveFactorUpdate_20240429();
  }
