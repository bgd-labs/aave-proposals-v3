 ...
 */
contract AaveV2Ethereum_ReserveFactorUpdatesLateSeptember_20240916 is IProposalGenericExecutor {
  ILendingPoolConfigurator public constant POOL_CONFIGURATOR =
    ILendingPoolConfigurator(AaveV2Ethereum.POOL_CONFIGURATOR);

  uint256 public constant DAI_RF = 80_00;
  uint256 public constant LINK_RF = 85_00;
  uint256 public constant USDC_RF = 80_00;
  uint256 public constant USDT_RF = 80_00;
  uint256 public constant WBTC_RF = 85_00;
