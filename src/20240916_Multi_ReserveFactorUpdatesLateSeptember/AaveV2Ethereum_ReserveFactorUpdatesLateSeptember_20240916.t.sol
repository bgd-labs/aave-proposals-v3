...
/**
 * @dev Test for AaveV2Ethereum_ReserveFactorUpdatesLateSeptember_20240916
 * command: FOUNDRY_PROFILE=mainnet forge test --match-path=src/20240916_Multi_ReserveFactorUpdatesLateSeptember/AaveV2Ethereum_ReserveFactorUpdatesLateSeptember_20240916.t.sol -vv
 */
contract AaveV2Ethereum_ReserveFactorUpdatesLateSeptember_20240916_Test is ProtocolV2TestBase {
  AaveV2Ethereum_ReserveFactorUpdatesLateSeptember_20240916 internal proposal;
  ...
  function setUp() public {
    vm.createSelectFork(vm.rpcUrl('mainnet'), 20763984);
    proposal = new AaveV2Ethereum_ReserveFactorUpdatesLateSeptember_20240916();
  }
  ...
  function test_defaultProposalExecution() public {
    (ReserveConfig[] memory allConfigsBefore, ReserveConfig[] memory allConfigsAfter) = defaultTest(
      'AaveV2Ethereum_ReserveFactorUpdatesLateSeptember_20240916',
      AaveV2Ethereum.POOL,
      address(proposal)
    );
