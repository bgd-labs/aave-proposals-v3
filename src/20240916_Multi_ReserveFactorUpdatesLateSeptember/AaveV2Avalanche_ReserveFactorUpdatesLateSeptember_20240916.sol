 ...
 */
contract AaveV2Avalanche_ReserveFactorUpdatesLateSeptember_20240916 is IProposalGenericExecutor {
  ILendingPoolConfigurator public constant POOL_CONFIGURATOR =
    ILendingPoolConfigurator(AaveV2Avalanche.POOL_CONFIGURATOR);

  uint256 public constant DAIe_RF = 75_00;
  uint256 public constant USDCe_RF = 75_00;
  uint256 public constant USDTe_RF = 75_00;
  uint256 public constant WAVAX_RF = 75_00;
  uint256 public constant WBTCe_RF = 80_00;
  uint256 public constant WETHe_RF = 75_00;
