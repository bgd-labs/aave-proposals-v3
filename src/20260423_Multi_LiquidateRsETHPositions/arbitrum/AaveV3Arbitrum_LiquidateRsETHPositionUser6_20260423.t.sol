...
import {AaveV3Arbitrum_LiquidateRsETHPositionUser6_20260423} from './AaveV3Arbitrum_LiquidateRsETHPositionUser6_20260423.sol';

/**
 * @dev Test for AaveV3Arbitrum_LiquidateRsETHPositionUser6_20260423
 * command: FOUNDRY_PROFILE=test forge test --match-path=src/20260423_Multi_LiquidateRsETHPositions/arbitrum/AaveV3Arbitrum_LiquidateRsETHPositionUser6_20260423.t.sol -vv
 */
contract AaveV3Arbitrum_LiquidateRsETHPositionUser6_20260423_Test is
  LiquidateRsETHArbitrumSetupTest
{
  function _newProposal() internal override returns (LiquidateRsETHPositionsSetup) {
    return new AaveV3Arbitrum_LiquidateRsETHPositionUser6_20260423();
  }

  function test_defaultProposalExecution() public {
    defaultTest({
      reportName: 'AaveV3Arbitrum_LiquidateRsETHPositionUser6_20260423',
      pool: _pool(),
  ...
  function test_user_matchesHardcodedAddress() public view {
    AaveV3Arbitrum_LiquidateRsETHPositionUser6_20260423 p = AaveV3Arbitrum_LiquidateRsETHPositionUser6_20260423(
        address(proposal)
      );
    assertEq(p.getUser(), 0x8d11AeAC74267DD5C56D371bf4AE1AFA174C2d49);
    assertEq(p.getUser(), LiquidateRsETHConstants.ARB_USER_6);
  }
  ...
  function test_liquidatedDebtAsset() public view override {
    assertEq(_liquidatedDebtAsset(), _wsteth());
  }
}
