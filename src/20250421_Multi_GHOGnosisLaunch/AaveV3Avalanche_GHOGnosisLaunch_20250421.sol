...
/**
 * @title GHO Gnosis Launch - Avalanche Bridge Update
 * @author kpk
 * @notice This proposal is used to launch GHO on Gnosis Chain via Avalanche bridge update
 * @dev This payload enables the GHO CCIP token pool to receive and send messages from Gnosis Chain on Avalanche.
 ...
 */
contract AaveV3Avalanche_GHOGnosisLaunch_20250421 is IProposalGenericExecutor {
