...
contract DeployEthereum is EthereumScript {
  function run() external broadcast {
    ...
    address payload1 = GovV3Helpers.deployDeterministic(
      type(AaveV3EthereumLido_ExtendSVRV1ToMoreReserves_20250429).creationCode
    );
...
/**
 * @dev Create Proposal
 * command: make deploy-ledger contract=src/20250429_Multi_ExtendSVRV1ToMoreReserves/ExtendSVRV1ToMoreReserves_20250429.s.sol:CreateProposal chain=mainnet
 */
  ...
  function run() external {
    ...
    GovV3Helpers.createProposal(
      ...
      GovV3Helpers.ipfsHashFile(
        vm,
        'src/20250429_Multi_ExtendSVRV1ToMoreReserves/ExtendSVRV1ToMoreReserves.md'
      )
    );
  }
}
