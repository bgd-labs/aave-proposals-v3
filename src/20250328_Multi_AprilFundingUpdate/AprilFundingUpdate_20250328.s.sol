...
import {EthereumScript, PolygonScript, ArbitrumScript, BaseScript} from 'solidity-utils/contracts/utils/ScriptUtils.sol';
...
/**
 * @dev Deploy Arbitrum
 * deploy-command: make deploy-ledger contract=src/20250328_Multi_AprilFundingUpdate/AprilFundingUpdate_20250328.s.sol:DeployArbitrum chain=arbitrum
 * verify-command: FOUNDRY_PROFILE=arbitrum npx catapulta-verify -b broadcast/AprilFundingUpdate_20250328.s.sol/42161/run-latest.json
 */
contract DeployArbitrum is ArbitrumScript {
  function run() external broadcast {
    // deploy payloads
    address payload0 = GovV3Helpers.deployDeterministic(
      type(AaveV3Arbitrum_AprilFundingUpdate_20250328).creationCode
    );
...
/**
 * @dev Deploy Base
 * deploy-command: make deploy-ledger contract=src/20250328_Multi_AprilFundingUpdate/AprilFundingUpdate_20250328.s.sol:DeployBase chain=base
 * verify-command: FOUNDRY_PROFILE=base npx catapulta-verify -b broadcast/AprilFundingUpdate_20250328.s.sol/8453/run-latest.json
 */
contract DeployBase is BaseScript {
  function run() external broadcast {
    // deploy payloads
    address payload0 = GovV3Helpers.deployDeterministic(
      type(AaveV3Base_AprilFundingUpdate_20250328).creationCode
    );
