 ...
 */
contract AaveV3Ethereum_OnboardCbBTCOnMainnetAndBase_20240917 is AaveV3PayloadEthereum {
  ...
  function _postExecute() internal override {
    IERC20(cbBTC).forceApprove(address(AaveV3Ethereum.POOL), cbBTC_SEED_AMOUNT);
    AaveV3Ethereum.POOL.supply(cbBTC, cbBTC_SEED_AMOUNT, address(AaveV3Ethereum.COLLECTOR), 0);
  }
