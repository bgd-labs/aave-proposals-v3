...
/**
 * @dev Test for AaveV3EthereumLido_SecurityServicesForAaveCurrentInfrastructureCertora_20251026
 * command: FOUNDRY_PROFILE=test forge test --match-path=src/20251026_AaveV3EthereumLido_SecurityServicesForAaveCurrentInfrastructureCertora/AaveV3EthereumLido_SecurityServicesForAaveCurrentInfrastructureCertora_20251026.t.sol -vv
 */
contract AaveV3EthereumLido_SecurityServicesForAaveCurrentInfrastructureCertora_20251026_Test is
  ProtocolV3TestBase
{
  AaveV3EthereumLido_SecurityServicesForAaveCurrentInfrastructureCertora_20251026 internal proposal;

  function setUp() public {
    vm.createSelectFork(vm.rpcUrl('mainnet'), 23663673);
    proposal = new AaveV3EthereumLido_SecurityServicesForAaveCurrentInfrastructureCertora_20251026();
  }
  ...
  function test_defaultProposalExecution() public {
    defaultTest(
      'AaveV3EthereumLido_SecurityServicesForAaveCurrentInfrastructureCertora_20251026',
