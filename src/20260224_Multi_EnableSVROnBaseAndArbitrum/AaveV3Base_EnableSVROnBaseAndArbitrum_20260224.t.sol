...
/**
 * @dev Test for AaveV3Base_EnableSVROnBaseAndArbitrum_20260224
 * command: FOUNDRY_PROFILE=test forge test --match-path=src/20260224_Multi_EnableSVROnBaseAndArbitrum/AaveV3Base_EnableSVROnBaseAndArbitrum_20260224.t.sol -vv
 */
contract AaveV3Base_EnableSVROnBaseAndArbitrum_20260224_Test is ProtocolV3TestBase {
  ...
  function test_defaultProposalExecution() public {
    defaultTest(
      'AaveV3Base_EnableSVROnBaseAndArbitrum_20260224',
      AaveV3Base.POOL,
      address(proposal)
    );
  }
