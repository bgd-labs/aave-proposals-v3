...
/**
 * @dev Test for AaveV3Soneium_MaintenanceGrantALRETRY_ROLEOnADI_20260603
 * command: FOUNDRY_PROFILE=test forge test --match-path=src/20260603_Multi_MaintenanceGrantALRETRY_ROLEOnADI/AaveV3Soneium_MaintenanceGrantALRETRY_ROLEOnADI_20260603.t.sol -vv
 */
contract AaveV3Soneium_MaintenanceGrantALRETRY_ROLEOnADI_20260603_Test is ProtocolV3TestBase {
  AaveV3Soneium_MaintenanceGrantALRETRY_ROLEOnADI_20260603 internal proposal;
  IGranularGuardianAccessControl internal GRANULAR_GUARDIAN =
    IGranularGuardianAccessControl(GovernanceV3Soneium.GRANULAR_GUARDIAN);

  function setUp() public {
    vm.createSelectFork(vm.rpcUrl('soneium'), 23677487);
    proposal = new AaveV3Soneium_MaintenanceGrantALRETRY_ROLEOnADI_20260603();
  }
  ...
  function test_defaultProposalExecution() public {
    defaultTest(
      'AaveV3Soneium_MaintenanceGrantALRETRY_ROLEOnADI_20260603',
      AaveV3Soneium.POOL,
      address(proposal)
    );
  }
