...
contract AaveV3Mantle_MaintenanceGrantALRETRY_ROLEOnADI_20260603_Test is
  MaintenanceGrantALRETRY_ROLEOnADITestBase
{
  ...
  function _deployProposal() internal override returns (IRetryRoleProposal) {
    return
      IRetryRoleProposal(address(new AaveV3Mantle_MaintenanceGrantALRETRY_ROLEOnADI_20260603()));
  }
  ...
  function _reportName() internal pure override returns (string memory) {
    return 'AaveV3Mantle_MaintenanceGrantALRETRY_ROLEOnADI_20260603';
  }
}
