...
/**
 * @dev Test for AaveV3Mantle_MaintenanceGrantALRETRY_ROLEOnADI_20260603
 * command: FOUNDRY_PROFILE=test forge test --match-path=src/20260603_Multi_MaintenanceGrantALRETRY_ROLEOnADI/AaveV3Mantle_MaintenanceGrantALRETRY_ROLEOnADI_20260603.t.sol -vv
 */
contract AaveV3Mantle_MaintenanceGrantALRETRY_ROLEOnADI_20260603_Test is ProtocolV3TestBase {
  AaveV3Mantle_MaintenanceGrantALRETRY_ROLEOnADI_20260603 internal proposal;
  IGranularGuardianAccessControl internal GRANULAR_GUARDIAN =
    IGranularGuardianAccessControl(GovernanceV3Mantle.GRANULAR_GUARDIAN);

  function setUp() public {
    vm.createSelectFork(vm.rpcUrl('mantle'), 96179708);
    proposal = new AaveV3Mantle_MaintenanceGrantALRETRY_ROLEOnADI_20260603();
  }
  ...
  function test_defaultProposalExecution() public {
    defaultTest(
      'AaveV3Mantle_MaintenanceGrantALRETRY_ROLEOnADI_20260603',
      AaveV3Mantle.POOL,
      address(proposal)
    );
  }
