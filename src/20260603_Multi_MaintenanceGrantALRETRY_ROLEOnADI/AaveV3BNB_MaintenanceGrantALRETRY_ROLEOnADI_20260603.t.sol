 ...
 */
contract AaveV3BNB_MaintenanceGrantALRETRY_ROLEOnADI_20260603_Test is ProtocolV3TestBase {
  AaveV3BNB_MaintenanceGrantALRETRY_ROLEOnADI_20260603 internal proposal;
  IGranularGuardianAccessControl internal GRANULAR_GUARDIAN =
    IGranularGuardianAccessControl(GovernanceV3BNB.GRANULAR_GUARDIAN);

  function setUp() public {
    vm.createSelectFork(vm.rpcUrl('bnb'), 102072793);
    proposal = new AaveV3BNB_MaintenanceGrantALRETRY_ROLEOnADI_20260603();
  }
  ...
  function test_defaultProposalExecution() public {
    defaultTest(
      'AaveV3BNB_MaintenanceGrantALRETRY_ROLEOnADI_20260603',
      AaveV3BNB.POOL,
      address(proposal)
    );
  }
