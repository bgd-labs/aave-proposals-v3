 ...
 */
contract AaveV3Sonic_MaintenanceGrantALRETRY_ROLEOnADI_20260603_Test is ProtocolV3TestBase {
  AaveV3Sonic_MaintenanceGrantALRETRY_ROLEOnADI_20260603 internal proposal;
  IGranularGuardianAccessControl internal GRANULAR_GUARDIAN =
    IGranularGuardianAccessControl(GovernanceV3Sonic.GRANULAR_GUARDIAN);

  function setUp() public {
    vm.createSelectFork(vm.rpcUrl('sonic'), 72292126);
    proposal = new AaveV3Sonic_MaintenanceGrantALRETRY_ROLEOnADI_20260603();
  }
  ...
  function test_defaultProposalExecution() public {
    defaultTest(
      'AaveV3Sonic_MaintenanceGrantALRETRY_ROLEOnADI_20260603',
      AaveV3Sonic.POOL,
      address(proposal)
    );
  }
