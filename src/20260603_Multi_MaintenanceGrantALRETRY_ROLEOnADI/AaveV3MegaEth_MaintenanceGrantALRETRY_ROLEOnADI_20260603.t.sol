 ...
 */
contract AaveV3MegaEth_MaintenanceGrantALRETRY_ROLEOnADI_20260603_Test is ProtocolV3TestBase {
  AaveV3MegaEth_MaintenanceGrantALRETRY_ROLEOnADI_20260603 internal proposal;
  IGranularGuardianAccessControl internal GRANULAR_GUARDIAN =
    IGranularGuardianAccessControl(GovernanceV3MegaEth.GRANULAR_GUARDIAN);

  function setUp() public {
    vm.createSelectFork(vm.rpcUrl('megaeth'), 17692718);
    proposal = new AaveV3MegaEth_MaintenanceGrantALRETRY_ROLEOnADI_20260603();
  }
  ...
  function test_defaultProposalExecution() public {
    defaultTest(
      'AaveV3MegaEth_MaintenanceGrantALRETRY_ROLEOnADI_20260603',
      AaveV3MegaEth.POOL,
      address(proposal)
    );
  }
