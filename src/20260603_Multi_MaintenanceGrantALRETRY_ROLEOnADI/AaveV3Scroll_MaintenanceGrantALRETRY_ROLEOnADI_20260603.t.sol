 ...
 */
contract AaveV3Scroll_MaintenanceGrantALRETRY_ROLEOnADI_20260603_Test is ProtocolV3TestBase {
  AaveV3Scroll_MaintenanceGrantALRETRY_ROLEOnADI_20260603 internal proposal;
  IGranularGuardianAccessControl internal GRANULAR_GUARDIAN =
    IGranularGuardianAccessControl(GovernanceV3Scroll.GRANULAR_GUARDIAN);

  function setUp() public {
    vm.createSelectFork(vm.rpcUrl('scroll'), 33939451);
    proposal = new AaveV3Scroll_MaintenanceGrantALRETRY_ROLEOnADI_20260603();
  }
  ...
  function test_defaultProposalExecution() public {
    defaultTest(
      'AaveV3Scroll_MaintenanceGrantALRETRY_ROLEOnADI_20260603',
      AaveV3Scroll.POOL,
      address(proposal)
    );
  }
