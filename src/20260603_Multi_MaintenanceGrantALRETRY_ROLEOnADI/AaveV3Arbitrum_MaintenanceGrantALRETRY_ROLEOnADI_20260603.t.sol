 ...
 */
contract AaveV3Arbitrum_MaintenanceGrantALRETRY_ROLEOnADI_20260603_Test is ProtocolV3TestBase {
  AaveV3Arbitrum_MaintenanceGrantALRETRY_ROLEOnADI_20260603 internal proposal;
  IGranularGuardianAccessControl internal GRANULAR_GUARDIAN =
    IGranularGuardianAccessControl(GovernanceV3Arbitrum.GRANULAR_GUARDIAN);

  function setUp() public {
    vm.createSelectFork(vm.rpcUrl('arbitrum'), 469618015);
    proposal = new AaveV3Arbitrum_MaintenanceGrantALRETRY_ROLEOnADI_20260603();
  }
  ...
  function test_defaultProposalExecution() public {
    defaultTest(
      'AaveV3Arbitrum_MaintenanceGrantALRETRY_ROLEOnADI_20260603',
      AaveV3Arbitrum.POOL,
      address(proposal)
    );
  }
