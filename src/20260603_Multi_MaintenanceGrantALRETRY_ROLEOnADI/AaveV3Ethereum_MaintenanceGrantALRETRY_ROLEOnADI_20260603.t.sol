 ...
 */
contract AaveV3Ethereum_MaintenanceGrantALRETRY_ROLEOnADI_20260603_Test is ProtocolV3TestBase {
  AaveV3Ethereum_MaintenanceGrantALRETRY_ROLEOnADI_20260603 internal proposal;
  ...
  function setUp() public {
    vm.createSelectFork(vm.rpcUrl('mainnet'), 25236865);
    proposal = new AaveV3Ethereum_MaintenanceGrantALRETRY_ROLEOnADI_20260603();
  }
  ...
  function test_defaultProposalExecution() public {
    defaultTest(
      'AaveV3Ethereum_MaintenanceGrantALRETRY_ROLEOnADI_20260603',
      AaveV3Ethereum.POOL,
      address(proposal)
    );
  }
