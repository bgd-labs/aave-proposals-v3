 ...
 */
contract AaveV3BNB_MaintenanceGrantALRETRY_ROLEOnADI_20260603 is IProposalGenericExecutor {
  // https://bscscan.com/address/0x2B99790c35a401be873FA7Eb514D9220736BB1cA
  address public constant AAVE_LABS_GUARDIAN = 0x2B99790c35a401be873FA7Eb514D9220736BB1cA;

  function execute() external {
    IGranularGuardianAccessControl(GovernanceV3BNB.GRANULAR_GUARDIAN).grantRole(
      IGranularGuardianAccessControl(GovernanceV3BNB.GRANULAR_GUARDIAN).RETRY_ROLE(),
      AAVE_LABS_GUARDIAN
    );
  }
}
