...
import {WethEthMockChainlinkOracle} from './WethEthMockChainlinkOracle.sol';
/**
 * @dev Deploy Ethereum
...
/**
 * @dev Deploy Mock
 * command: make deploy-ledger contract=src/20231103_AaveV3Ethereum_TreasuryManagementAddToRETHHolding/TreasuryManagementAddToRETHHolding_20231103.s.sol:DeployMock chain=mainnet
 */
contract DeployMock is EthereumScript {
  function run() external broadcast {
    // deploy payloads
    WethEthMockChainlinkOracle payload0 = new WethEthMockChainlinkOracle();
  }
}
