...
contract AaveV4Ethereum_IncreaseCaps_20260520_Test is ProtocolV4TestBase {
  ...
  function test_caps_coreHub() public virtual {
    ...
    //                                                                                                                  addCap      drawCap
    _assertCaps(CORE_HUB, address(AaveV4EthereumSpokes.ETHERFI_ESPOKE), AaveV4EthereumAssets.WETH_UNDERLYING,          0,          8_500);
    _assertCaps(CORE_HUB, address(AaveV4EthereumSpokes.ETHERFI_ESPOKE), AaveV4EthereumAssets.weETH_UNDERLYING,         8_500,      0);
    _assertCaps(CORE_HUB, address(AaveV4EthereumSpokes.LIDO_ESPOKE),    AaveV4EthereumAssets.WETH_UNDERLYING,          0,          4_800);
