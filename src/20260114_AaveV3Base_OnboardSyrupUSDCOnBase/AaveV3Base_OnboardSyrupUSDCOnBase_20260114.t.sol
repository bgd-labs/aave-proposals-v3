...
/**
 * @dev Test for AaveV3Base_OnboardSyrupUSDCOnBase_20260114
 * command: FOUNDRY_PROFILE=test forge test --match-path=src/20260114_AaveV3Base_OnboardSyrupUSDCOnBase/AaveV3Base_OnboardSyrupUSDCOnBase_20260114.t.sol -vv
 */
contract AaveV3Base_OnboardSyrupUSDCOnBase_20260114_Test is ProtocolV3TestBase {
  ...
  function test_defaultProposalExecution() public {
    defaultTest('AaveV3Base_OnboardSyrupUSDCOnBase_20260114', AaveV3Base.POOL, address(proposal));
  }
  ...
  function test_dustBinHassyrupUSDCFunds() public {
    ...
    assertGe(IERC20(aTokenAddress).balanceOf(address(AaveV3Base.DUST_BIN)), 100e6);
  }
