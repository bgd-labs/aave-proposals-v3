...
/**
 * @dev Test for AaveV2Avalanche_ReserveFactorUpgrades_20240524
 * command: FOUNDRY_PROFILE=avalanche forge test --match-path=src/20240524_Multi_ReserveFactorUpgrades/AaveV2Avalanche_ReserveFactorUpgrades_20240524.t.sol -vv
 */
contract AaveV2Avalanche_ReserveFactorUpgrades_20240524_Test is ProtocolV2TestBase {
  AaveV2Avalanche_ReserveFactorUpgrades_20240524 internal proposal;
  ...
  function setUp() public {
    vm.createSelectFork(vm.rpcUrl('avalanche'), 45827928);
    proposal = new AaveV2Avalanche_ReserveFactorUpgrades_20240524();
  }
