...
/**
 * @dev Deploy Arbitrum
 * deploy-command: make deploy-ledger contract=src/20250805_AaveV3Arbitrum_ArbitrumEModeUpdateRsETHAndEzETH/ArbitrumEModeUpdateRsETHAndEzETH_20250805.s.sol:DeployArbitrum chain=arbitrum
 * verify-command: FOUNDRY_PROFILE=deploy npx catapulta-verify -b broadcast/ArbitrumEModeUpdateRsETHAndEzETH_20250805.s.sol/42161/run-latest.json
 */
  ...
  function run() external {
    ...
    GovV3Helpers.createProposal(
      ...
      GovV3Helpers.ipfsHashFile(
        vm,
        'src/20250805_AaveV3Arbitrum_ArbitrumEModeUpdateRsETHAndEzETH/ArbitrumEModeUpdateRsETHAndEzETH.md'
      )
    );
  }
}
