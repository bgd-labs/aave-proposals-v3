...
/**
 * @dev Test for AaveV2Avalanche_ReserveFactorUpgrades_20240506
 * command: make test-contract filter=AaveV2Avalanche_ReserveFactorUpgrades_20240506
 */
contract AaveV2Avalanche_ReserveFactorUpgrades_20240506_Test is ProtocolV2TestBase {
  AaveV2Avalanche_ReserveFactorUpgrades_20240506 internal proposal;
  ...
  function setUp() public {
    vm.createSelectFork(vm.rpcUrl('avalanche'), 45105736);
    proposal = new AaveV2Avalanche_ReserveFactorUpgrades_20240506();
  }
