 ...
 */
contract AaveV2Avalanche_ReserveFactorUpgrades_20240506 is IProposalGenericExecutor {
  ILendingPoolConfigurator public constant POOL_CONFIGURATOR =
    ILendingPoolConfigurator(AaveV2Avalanche.POOL_CONFIGURATOR);

  uint256 public constant DAIe_RF = 45_00;
  uint256 public constant USDCe_RF = 45_00;
  uint256 public constant USDTe_RF = 45_00;
  uint256 public constant WAVAX_RF = 45_00;
  uint256 public constant WBTCe_RF = 50_00;
  uint256 public constant WETHe_RF = 45_00;
