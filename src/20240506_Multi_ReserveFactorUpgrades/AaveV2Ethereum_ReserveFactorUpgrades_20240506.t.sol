...
/**
 * @dev Test for AaveV2Ethereum_ReserveFactorUpgrades_20240506
 * command: make test-contract filter=AaveV2Ethereum_ReserveFactorUpgrades_20240506
 */
contract AaveV2Ethereum_ReserveFactorUpgrades_20240506_Test is ProtocolV2TestBase {
  AaveV2Ethereum_ReserveFactorUpgrades_20240506 internal proposal;
  ...
  function setUp() public {
    vm.createSelectFork(vm.rpcUrl('mainnet'), 19812001);
    proposal = new AaveV2Ethereum_ReserveFactorUpgrades_20240506();
  }
