...
In scenarios where borrowing demand for USDtb exceeds safe thresholds, Aave can dynamically adjust the variable interest rate curve to discourage further exposure. Here, *safe thresholds* refer to the level at which the amount of USDtb borrowed on Aave begins to represent an outsized share of the stablecoin portion of USDe backing. Steepening the slope parameters at or beyond the optimal utilization point can effectively reduce excessive borrowing activity and help maintain balanced market dynamics.
