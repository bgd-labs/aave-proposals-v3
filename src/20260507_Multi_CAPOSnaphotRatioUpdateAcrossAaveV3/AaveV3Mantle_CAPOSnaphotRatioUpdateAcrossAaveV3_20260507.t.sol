...
/**
 * @dev Test for AaveV3Mantle_CAPOSnaphotRatioUpdateAcrossAaveV3_20260507
 * command: FOUNDRY_PROFILE=test forge test --match-path=src/20260507_Multi_CAPOSnaphotRatioUpdateAcrossAaveV3/AaveV3Mantle_CAPOSnaphotRatioUpdateAcrossAaveV3_20260507.t.sol -vv
 */
contract AaveV3Mantle_CAPOSnaphotRatioUpdateAcrossAaveV3_20260507_Test is
  ProtocolV3TestBase,
  CAPOUpdateBaseTest
{
  AaveV3Mantle_CAPOSnaphotRatioUpdateAcrossAaveV3_20260507 internal proposal;

  function setUp() public {
    vm.createSelectFork(vm.rpcUrl('mantle'), 95023228);
    proposal = new AaveV3Mantle_CAPOSnaphotRatioUpdateAcrossAaveV3_20260507();
  }
  ...
  function _runRetrospective(address adapter, string memory symbol) internal {
    _runRetrospectiveAndReport({
      ...
      reportName: string.concat(
        'AaveV3Mantle_CAPOSnaphotRatioUpdateAcrossAaveV3_20260507_',
        symbol,
        '_Capo'
      )
    });
