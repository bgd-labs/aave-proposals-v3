...
/**
 * @dev Test for AaveV3Linea_CAPOSnaphotRatioUpdateAcrossAaveV3_20260507
 * command: FOUNDRY_PROFILE=test forge test --match-path=src/20260507_Multi_CAPOSnaphotRatioUpdateAcrossAaveV3/AaveV3Linea_CAPOSnaphotRatioUpdateAcrossAaveV3_20260507.t.sol -vv
 */
contract AaveV3Linea_CAPOSnaphotRatioUpdateAcrossAaveV3_20260507_Test is
  ProtocolV3TestBase,
  CAPOUpdateBaseTest
{
  AaveV3Linea_CAPOSnaphotRatioUpdateAcrossAaveV3_20260507 internal proposal;

  function setUp() public {
    vm.createSelectFork(vm.rpcUrl('linea'), 30547773);
    proposal = new AaveV3Linea_CAPOSnaphotRatioUpdateAcrossAaveV3_20260507();
  }
  ...
  function test_defaultProposalExecution() public {
    defaultTest(
      'AaveV3Linea_CAPOSnaphotRatioUpdateAcrossAaveV3_20260507',
      AaveV3Linea.POOL,
      address(proposal)
    );
  }
  ...
  function _runRetrospective(address adapter, string memory symbol) internal {
    _runRetrospectiveAndReport({
      ...
      reportName: string.concat(
        'AaveV3Linea_CAPOSnaphotRatioUpdateAcrossAaveV3_20260507_',
        symbol,
        '_Capo'
      )
    });
