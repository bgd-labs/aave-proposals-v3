  ...
  ProtocolV3TestBase
{
  ...
  function setUp() public {
    vm.createSelectFork(vm.rpcUrl('mainnet'), 23233948);
  ...
  function test_injectUpdateToProtocol() public {
    ...
    IPendlePriceCapAdapter PT_ORACLE = IPendlePriceCapAdapter(
      AaveV3Ethereum.ORACLE.getSourceOfAsset(proposal.PT_sUSDe_27NOV2025())
    );
  ...
  function test_inject_EMode24UpdateToProtocol() public {
    executePayload(vm, address(proposal));
  ...
  function test_inject_EMode25UpdateToProtocol() public {
    executePayload(vm, address(proposal));
