...
| 3\. Full DAO control (Gov-V3 X-Chain) | Cross-chain executor audited and markets stable (timelines estimation available after initial research) | Gov-v3 bridge           | UpgradeAdmin, RiskAdmin, etc.                                                                                                                                              |
