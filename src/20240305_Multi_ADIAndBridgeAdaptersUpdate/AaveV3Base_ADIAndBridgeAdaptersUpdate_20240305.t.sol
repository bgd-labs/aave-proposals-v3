 ...
 */
contract AaveV3Base_ADIAndBridgeAdaptersUpdate_20240305_Test is BaseTest {
  AaveV3Base_ADIAndBridgeAdaptersUpdate_20240305 internal payload;

  constructor()
    BaseTest(GovernanceV3Base.CROSS_CHAIN_CONTROLLER, MiscBase.PROXY_ADMIN, 'base', 11725901)
  {}

  function setUp() public override {
    super.setUp();
    payload = new AaveV3Base_ADIAndBridgeAdaptersUpdate_20240305();
  ...
  function _getAdapterNames() internal view override returns (AdapterName[] memory) {
    ...
    adapterNames[0] = AdapterName({adapter: payload.NEW_ADAPTER(), name: 'Base native adapter'});
