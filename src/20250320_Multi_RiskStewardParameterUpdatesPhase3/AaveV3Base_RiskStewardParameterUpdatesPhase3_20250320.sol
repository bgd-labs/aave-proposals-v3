 ...
 */
contract AaveV3Base_RiskStewardParameterUpdatesPhase3_20250320 is IProposalGenericExecutor {
  function execute() external {
    IRiskSteward(AaveV3Base.RISK_STEWARD).setRiskConfig(GetRiskConfig._getRiskConfig());
  }
}
