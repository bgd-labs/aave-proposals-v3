 ...
 */
contract AaveV3Linea_RiskStewardParameterUpdatesPhase3_20250320 is IProposalGenericExecutor {
  function execute() external {
    // custom code goes here
    IRiskSteward(AaveV3Linea.RISK_STEWARD).setRiskConfig(GetRiskConfig._getRiskConfig());
  }
}
