 ...
 */
contract AaveV3EthereumLido_RiskStewardParameterUpdatesPhase3_20250320 is IProposalGenericExecutor {
  function execute() external {
    IRiskSteward(AaveV3EthereumLido.RISK_STEWARD).setRiskConfig(GetRiskConfig._getRiskConfig());
  }
}
