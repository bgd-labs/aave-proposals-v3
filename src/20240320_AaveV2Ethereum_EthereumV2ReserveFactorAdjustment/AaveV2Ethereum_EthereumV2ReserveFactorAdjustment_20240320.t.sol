...
/**
 * @dev Test for AaveV2Ethereum_EthereumV2ReserveFactorAdjustment_20240320
 * command: make test-contract filter=AaveV2Ethereum_EthereumV2ReserveFactorAdjustment_20240320
 */
contract AaveV2Ethereum_EthereumV2ReserveFactorAdjustment_20240320_Test is ProtocolV2TestBase {
  AaveV2Ethereum_EthereumV2ReserveFactorAdjustment_20240320 internal proposal;
  ...
  function setUp() public {
    vm.createSelectFork(vm.rpcUrl('mainnet'), 19476014);
    proposal = new AaveV2Ethereum_EthereumV2ReserveFactorAdjustment_20240320();
  }
