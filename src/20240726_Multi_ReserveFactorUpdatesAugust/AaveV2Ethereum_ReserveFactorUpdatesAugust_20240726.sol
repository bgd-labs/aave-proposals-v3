 ...
 */
contract AaveV2Ethereum_ReserveFactorUpdatesAugust_20240726 is IProposalGenericExecutor {
  ILendingPoolConfigurator public constant POOL_CONFIGURATOR =
    ILendingPoolConfigurator(AaveV2Ethereum.POOL_CONFIGURATOR);

  uint256 public constant DAI_RF = 70_00;
  uint256 public constant LINK_RF = 75_00;
  uint256 public constant USDC_RF = 70_00;
  uint256 public constant USDT_RF = 70_00;
  uint256 public constant WBTC_RF = 75_00;
  uint256 public constant WETH_RF = 70_00;
