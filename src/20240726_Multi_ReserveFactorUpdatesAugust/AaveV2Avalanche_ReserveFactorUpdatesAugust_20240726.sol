 ...
 */
contract AaveV2Avalanche_ReserveFactorUpdatesAugust_20240726 is IProposalGenericExecutor {
  ILendingPoolConfigurator public constant POOL_CONFIGURATOR =
    ILendingPoolConfigurator(AaveV2Avalanche.POOL_CONFIGURATOR);

  uint256 public constant DAIe_RF = 65_00;
  uint256 public constant USDCe_RF = 65_00;
  uint256 public constant USDTe_RF = 65_00;
  uint256 public constant WAVAX_RF = 65_00;
  uint256 public constant WBTCe_RF = 70_00;
  uint256 public constant WETHe_RF = 65_00;
