...
/**
 * @dev Test for AaveV2Ethereum_ReserveFactorUpdatesAugust_20240726
 * command: FOUNDRY_PROFILE=mainnet forge test --match-path=src/20240726_Multi_ReserveFactorUpdatesAugust/AaveV2Ethereum_ReserveFactorUpdatesAugust_20240726.t.sol -vv
 */
contract AaveV2Ethereum_ReserveFactorUpdatesAugust_20240726_Test is ProtocolV2TestBase {
  AaveV2Ethereum_ReserveFactorUpdatesAugust_20240726 internal proposal;
  ...
  function test_defaultProposalExecution() public {
    (ReserveConfig[] memory allConfigsBefore, ReserveConfig[] memory allConfigsAfter) = defaultTest(
      'AaveV2Ethereum_ReserveFactorUpdatesAugust_20240726',
      AaveV2Ethereum.POOL,
      address(proposal)
    );
