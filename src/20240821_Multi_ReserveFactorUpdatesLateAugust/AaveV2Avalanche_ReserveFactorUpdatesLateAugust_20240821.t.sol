...
/**
 * @dev Test for AaveV2Avalanche_ReserveFactorUpdatesLateAugust_20240821
 * command: FOUNDRY_PROFILE=avalanche forge test --match-path=src/20240821_Multi_ReserveFactorUpdatesLateAugust/AaveV2Avalanche_ReserveFactorUpdatesLateAugust_20240821.t.sol -vv
 */
contract AaveV2Avalanche_ReserveFactorUpdatesLateAugust_20240821_Test is ProtocolV2TestBase {
  AaveV2Avalanche_ReserveFactorUpdatesLateAugust_20240821 internal proposal;
  ...
  function setUp() public {
    vm.createSelectFork(vm.rpcUrl('avalanche'), 49543127);
    proposal = new AaveV2Avalanche_ReserveFactorUpdatesLateAugust_20240821();
  }
  ...
  function test_defaultProposalExecution() public {
    (ReserveConfig[] memory allConfigsBefore, ReserveConfig[] memory allConfigsAfter) = defaultTest(
      'AaveV2Avalanche_ReserveFactorUpdatesLateAugust_20240821',
