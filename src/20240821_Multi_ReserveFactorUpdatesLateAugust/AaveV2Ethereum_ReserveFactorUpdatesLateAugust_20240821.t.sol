...
/**
 * @dev Test for AaveV2Ethereum_ReserveFactorUpdatesLateAugust_20240821
 * command: FOUNDRY_PROFILE=mainnet forge test --match-path=src/20240821_Multi_ReserveFactorUpdatesLateAugust/AaveV2Ethereum_ReserveFactorUpdatesLateAugust_20240821.t.sol -vv
 */
contract AaveV2Ethereum_ReserveFactorUpdatesLateAugust_20240821_Test is ProtocolV2TestBase {
  AaveV2Ethereum_ReserveFactorUpdatesLateAugust_20240821 internal proposal;
  ...
  function setUp() public {
    vm.createSelectFork(vm.rpcUrl('mainnet'), 20592360);
    proposal = new AaveV2Ethereum_ReserveFactorUpdatesLateAugust_20240821();
  }
  ...
  function test_defaultProposalExecution() public {
    (ReserveConfig[] memory allConfigsBefore, ReserveConfig[] memory allConfigsAfter) = defaultTest(
      'AaveV2Ethereum_ReserveFactorUpdatesLateAugust_20240821',
      AaveV2Ethereum.POOL,
      address(proposal)
    );
