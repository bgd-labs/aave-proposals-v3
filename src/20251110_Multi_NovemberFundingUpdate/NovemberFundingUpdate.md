...
This publication balances near term operational needs, consolidates assets holdings and extends some Allowances to the MainnetSwapSteward to support optimising the DAOs stablecoin holdings.
