...
import {IAaveCLRobotOperator, AaveV3BNB_AaveRobotMaintenance_Part2_20250330} from './AaveV3BNB_AaveRobotMaintenance_Part2_20250330.sol';
...
contract AaveV3BNB_AaveRobotMaintenance_Part2_20250330_Test is ProtocolV3TestBase {
  ...
  function setUp() public {
    ...
    IAaveCLRobotOperator(MiscBNB.AAVE_CL_ROBOT_OPERATOR).withdrawLink(
  ...
  function test_defaultProposalExecution() public {
    defaultTest(
      'AaveV3BNB_AaveRobotMaintenance_Part2_20250330',
      AaveV3BNB.POOL,
