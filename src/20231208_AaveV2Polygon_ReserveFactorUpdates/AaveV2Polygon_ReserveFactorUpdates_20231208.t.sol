...
/**
 * @dev Test for AaveV2Polygon_ReserveFactorUpdates_20231208
 * command: make test-contract filter=AaveV2Polygon_ReserveFactorUpdates_20231208
 */
contract AaveV2Polygon_ReserveFactorUpdates_20231208_Test is ProtocolV2TestBase {
  struct Changes {
    address asset;
    uint256 reserveFactor;
  }

  AaveV2Polygon_ReserveFactorUpdates_20231208 internal proposal;

  function setUp() public {
    vm.createSelectFork(vm.rpcUrl('polygon'), 51025898);
    proposal = new AaveV2Polygon_ReserveFactorUpdates_20231208();
  }
  ...
  function test_defaultProposalExecution() public {
    (ReserveConfig[] memory allConfigsBefore, ReserveConfig[] memory allConfigsAfter) = defaultTest(
      'AaveV2Polygon_ReserveFactorUpdates_20231208',
      AaveV2Polygon.POOL,
      address(proposal)
    );
