...
/**
 * @dev Test for AaveV2Avalanche_ReserveFactorUpdates_20240404
 * command: make test-contract filter=AaveV2Avalanche_ReserveFactorUpdates_20240404
 */
contract AaveV2Avalanche_ReserveFactorUpdates_20240404_Test is ProtocolV2TestBase {
  AaveV2Avalanche_ReserveFactorUpdates_20240404 internal proposal;
  ...
  function setUp() public {
    vm.createSelectFork(vm.rpcUrl('avalanche'), 43751168);
    proposal = new AaveV2Avalanche_ReserveFactorUpdates_20240404();
  }
  ...
  function test_defaultProposalExecution() public {
    (ReserveConfig[] memory allConfigsBefore, ReserveConfig[] memory allConfigsAfter) = defaultTest(
      'AaveV2Avalanche_ReserveFactorUpdates_20240404',
