...
import {IPoolAddressesProviderRegistry} from 'aave-v3-origin/contracts/interfaces/IPoolAddressesProviderRegistry.sol';
...
contract AaveV3EthereumEtherFi_EtherFiEthereumActivation_20240902 is AaveV3PayloadEthereumEtherFi {
  ...
  function _preExecute() internal override {
    ...
    IPoolAddressesProviderRegistry(AaveV3Ethereum.POOL_ADDRESSES_PROVIDER_REGISTRY)
      .registerAddressesProvider(address(AaveV3EthereumEtherFi.POOL_ADDRESSES_PROVIDER), 45);
  }
  ...
  function _postExecute() internal override {
    ...
    AaveV3EthereumEtherFi.POOL.supply(
      weETH,
      weETH_SEED_AMOUNT,
