...
/**
 * @dev Test for AaveV3Mantle_MaintenanceGrantALRETRY_ROLEOnADI_20260603_Part2
 * command: FOUNDRY_PROFILE=test forge test --match-path=src/20260603_Multi_MaintenanceGrantALRETRY_ROLEOnADI_Part2/AaveV3Mantle_MaintenanceGrantALRETRY_ROLEOnADI_20260603_Part2.t.sol -vv
 */
/// forge-config: default.isolate = true
contract AaveV3Mantle_MaintenanceGrantALRETRY_ROLEOnADI_20260603_Part2_Test is
  MaintenanceGrantALRETRY_ROLEOnADITestBase
{
  function _createFork() internal override {
    vm.createSelectFork(vm.rpcUrl('mantle'), 96747210);
  }

  function _deployProposal() internal override returns (IRetryRoleProposal) {
    return
      IRetryRoleProposal(
        address(new AaveV3Mantle_MaintenanceGrantALRETRY_ROLEOnADI_20260603_Part2())
      );
  }
  ...
  function _reportName() internal pure override returns (string memory) {
    return 'AaveV3Mantle_MaintenanceGrantALRETRY_ROLEOnADI_20260603_Part2';
  }
}
