 ...
 */
contract AaveV3InkWhitelabel_MaintenanceGrantALRETRY_ROLEOnADI_20260603_Part2 is
  IProposalGenericExecutor
{
  // https://explorer.inkonchain.com/address/0x2B99790c35a401be873FA7Eb514D9220736BB1cA
  address public constant AAVE_LABS_GUARDIAN = 0x2B99790c35a401be873FA7Eb514D9220736BB1cA;

  function execute() external {
    IGranularGuardianAccessControl(GovernanceV3Ink.GRANULAR_GUARDIAN).grantRole(
      IGranularGuardianAccessControl(GovernanceV3Ink.GRANULAR_GUARDIAN).RETRY_ROLE(),
      AAVE_LABS_GUARDIAN
    );
  }
}
