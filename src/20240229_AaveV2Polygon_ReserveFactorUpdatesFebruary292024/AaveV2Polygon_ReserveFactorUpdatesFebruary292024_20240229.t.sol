...
/**
 * @dev Test for AaveV2Polygon_ReserveFactorUpdatesFebruary292024_20240229
 * command: make test-contract filter=AaveV2Polygon_ReserveFactorUpdatesFebruary292024_20240229
 */
contract AaveV2Polygon_ReserveFactorUpdatesFebruary292024_20240229_Test is ProtocolV2TestBase {
  struct Changes {
    address asset;
    uint256 reserveFactor;
  }

  AaveV2Polygon_ReserveFactorUpdatesFebruary292024_20240229 internal proposal;

  function setUp() public {
    vm.createSelectFork(vm.rpcUrl('polygon'), 54098105);
    proposal = new AaveV2Polygon_ReserveFactorUpdatesFebruary292024_20240229();
  }
  ...
  function test_defaultProposalExecution() public {
    (ReserveConfig[] memory allConfigsBefore, ReserveConfig[] memory allConfigsAfter) = defaultTest(
      'AaveV2Polygon_ReserveFactorUpdates_20240229',
      AaveV2Polygon.POOL,
      address(proposal)
    );
    ...
    Changes[] memory assetChanges = new Changes[](4);
