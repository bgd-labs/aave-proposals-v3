 ...
 */
contract AaveV3EthereumEtherFi_RiskStewardsCooldownReductionAndUmbrellaPauserRoleReassignment_20260720 is
  IProposalGenericExecutor
{
  function execute() external {
    RiskStewardCooldownReduction.setRiskStewardMinDelay(AaveV3EthereumEtherFi.RISK_STEWARD);
  }
}
