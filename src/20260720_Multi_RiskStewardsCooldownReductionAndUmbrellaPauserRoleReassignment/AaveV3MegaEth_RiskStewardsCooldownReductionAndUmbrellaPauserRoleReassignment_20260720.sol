 ...
 */
contract AaveV3MegaEth_RiskStewardsCooldownReductionAndUmbrellaPauserRoleReassignment_20260720 is
  IProposalGenericExecutor
{
  function execute() external {
    RiskStewardCooldownReduction.setRiskStewardMinDelay(AaveV3MegaEth.RISK_STEWARD);
  }
}
