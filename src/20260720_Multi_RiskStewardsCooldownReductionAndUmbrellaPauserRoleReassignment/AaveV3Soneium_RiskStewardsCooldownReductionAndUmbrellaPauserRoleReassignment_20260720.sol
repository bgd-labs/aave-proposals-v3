 ...
 */
contract AaveV3Soneium_RiskStewardsCooldownReductionAndUmbrellaPauserRoleReassignment_20260720 is
  RiskStewardCooldownReductionBase
{
  function execute() external {
    _setRiskStewardMinDelayOld(AaveV3Soneium.RISK_STEWARD);
  }
}
