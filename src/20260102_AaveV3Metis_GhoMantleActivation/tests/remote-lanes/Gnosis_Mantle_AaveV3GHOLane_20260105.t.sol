  ...
  AaveV3GHORemoteLaneTest_PreExecution
{
  ...
  function _deployAaveV3GHOLaneProposal() internal virtual override returns (AaveV3GHOLane) {
    return new Gnosis_Mantle_AaveV3GHOLane_20260105();
  }

  function test_defaultProposalExecution() public virtual {
    defaultTest('Gnosis_Mantle_AaveV3GHOLane_20260105', AaveV3Gnosis.POOL, address(proposal));
  }
...
contract Gnosis_Mantle_AaveV3GHOLane_20260105_Test is AaveV3GHORemoteLane_1_6_Test_PostExecution {
  constructor()
