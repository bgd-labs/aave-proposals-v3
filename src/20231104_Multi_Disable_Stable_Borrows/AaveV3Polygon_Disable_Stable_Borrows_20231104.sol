...
contract AaveV3Polygon_Disable_Stable_Borrows_20231104 is AaveV3PayloadPolygon {
  ...
  {
    AaveV3Polygon.POOL_CONFIGURATOR.setReserveStableRateBorrowing(AaveV3PolygonAssets.DAI_UNDERLYING, false);
    AaveV3Polygon.POOL_CONFIGURATOR.setReserveStableRateBorrowing(AaveV3PolygonAssets.USDC_UNDERLYING, false);
    AaveV3Polygon.POOL_CONFIGURATOR.setReserveStableRateBorrowing(AaveV3PolygonAssets.USDT_UNDERLYING, false);
    AaveV3Polygon.POOL_CONFIGURATOR.setReserveStableRateBorrowing(AaveV3PolygonAssets.EURS_UNDERLYING, false);
