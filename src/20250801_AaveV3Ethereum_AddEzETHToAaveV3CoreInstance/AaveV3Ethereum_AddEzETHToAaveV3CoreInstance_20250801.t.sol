...
/**
 * @dev Test for AaveV3Ethereum_AddEzETHToAaveV3CoreInstance_20250801
 * command: FOUNDRY_PROFILE=test forge test --match-path=src/20250801_AaveV3Ethereum_AddEzETHToAaveV3CoreInstance/AaveV3Ethereum_AddEzETHToAaveV3CoreInstance_20250801.t.sol -vv
 */
contract AaveV3Ethereum_AddEzETHToAaveV3CoreInstance_20250801_Test is ProtocolV3TestBase {
  ...
  function test_defaultProposalExecution() public {
    defaultTest(
      'AaveV3Ethereum_AddEzETHToAaveV3CoreInstance_20250801',
      AaveV3Ethereum.POOL,
      address(proposal)
    );
  }
