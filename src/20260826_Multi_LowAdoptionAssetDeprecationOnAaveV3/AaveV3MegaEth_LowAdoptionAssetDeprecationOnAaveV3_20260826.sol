 ...
 */
contract AaveV3MegaEth_LowAdoptionAssetDeprecationOnAaveV3_20260826 is AaveV3PayloadMegaEth {
  function _postExecute() internal override {
    AaveV3MegaEth.POOL_CONFIGURATOR.setReserveFreeze(AaveV3MegaEthAssets.ezETH_UNDERLYING, true);
    AaveV3MegaEth.POOL_CONFIGURATOR.setReserveFreeze(AaveV3MegaEthAssets.USDT0_UNDERLYING, true);
  }
