 ...
 */
contract AaveV3Base_LowAdoptionAssetDeprecationOnAaveV3_20260826 is AaveV3PayloadBase {
  function _postExecute() internal override {
    AaveV3Base.POOL_CONFIGURATOR.setReserveFreeze(AaveV3BaseAssets.tBTC_UNDERLYING, true);
    AaveV3Base.POOL_CONFIGURATOR.setReserveFreeze(AaveV3BaseAssets.ezETH_UNDERLYING, true);
    AaveV3Base.POOL_CONFIGURATOR.setReserveFreeze(AaveV3BaseAssets.USDbC_UNDERLYING, true);
  }
