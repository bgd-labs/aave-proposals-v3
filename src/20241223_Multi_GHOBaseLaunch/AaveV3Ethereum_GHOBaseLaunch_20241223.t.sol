...
contract AaveV3Ethereum_GHOBaseLaunch_20241223_Test is ProtocolV3TestBase {
  ...
  function setUp() public {
    ...
    proposal = new AaveV3Ethereum_GHOBaseLaunch_20241223(address(0), address(0), address(0));
  }
  ...
  function test_defaultProposalExecution() public {
    defaultTest('AaveV3Ethereum_GHOBaseLaunch_20241223', AaveV3Ethereum.POOL, address(proposal));
  }
}
