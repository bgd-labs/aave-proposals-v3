...
contract AaveV3Arbitrum_GHOBaseLaunch_20241223_Test is ProtocolV3TestBase {
  ...
  function setUp() public {
    ...
    proposal = new AaveV3Arbitrum_GHOBaseLaunch_20241223(address(0), address(0), address(0));
  }
  ...
  function test_defaultProposalExecution() public {
    defaultTest('AaveV3Arbitrum_GHOBaseLaunch_20241223', AaveV3Arbitrum.POOL, address(proposal));
  }
}
