...
/**
 * @dev Test for AaveV4Ethereum_IncreaseCaps_20260527
 * command: FOUNDRY_PROFILE=test forge test --match-path=src/20260527_AaveV4Ethereum_IncreaseCaps/AaveV4Ethereum_IncreaseCaps_20260527.t.sol -vv
 */
contract AaveV4Ethereum_IncreaseCaps_20260527_Test is ProtocolV4TestBase {
  AaveV4Ethereum_IncreaseCaps_20260527 internal payload;
  ...
  function setUp() public virtual {
    vm.createSelectFork(vm.rpcUrl('mainnet'), 25184840);

    payload = new AaveV4Ethereum_IncreaseCaps_20260527();
  }
  ...
  function test_caps_coreHub_before() public virtual {
    ...
    _assertCaps(CORE_HUB, address(AaveV4EthereumSpokes.GOLD_SPOKE),  AaveV4EthereumAssets.USDC_UNDERLYING,   0,          125_000);
    _assertCaps(CORE_HUB, address(AaveV4EthereumSpokes.GOLD_SPOKE),  AaveV4EthereumAssets.USDG_UNDERLYING,   0,          62_500);
