...
uint256 constant AVALANCHE_BLOCK_NUMBER = 88588236;

contract Avalanche_Monad_AaveV3GHOLane_20260105_Test_PreExecution is
  AaveV3GHORemoteLaneTest_PreExecution
{
  ...
  function _deployAaveV3GHOLaneProposal() internal virtual override returns (AaveV3GHOLane) {
    return new AaveV3Avalanche_GhoMonadActivation_20260518();
  }

  function test_defaultProposalExecution() public virtual {
    defaultTest(
      'AaveV3Avalanche_GhoMonadActivation_20260518',
...
contract Avalanche_Monad_AaveV3GHOLane_20260105_Test_PostExecution is
