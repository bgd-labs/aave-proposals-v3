...
abstract contract BaseTest is ProtocolV3TestBase {
  ...
  function setUp() public {
    ...
    ethereumPayload = new AaveV3Ethereum_HyperlaneBridgeAdapterUpdateToV3_20240320();
    polygonPayload = new AaveV3Polygon_HyperlaneBridgeAdapterUpdateToV3_20240320();
    avalanchePayload = new AaveV3Avalanche_HyperlaneBridgeAdapterUpdateToV3_20240320();
    binancePayload = new AaveV3BNB_HyperlaneBridgeAdapterUpdateToV3_20240320();
    gnosisPayload = new AaveV3Gnosis_HyperlaneBridgeAdapterUpdateToV3_20240320();
  }
