 ...
 * - Discussion: https://governance.aave.com/t/arfc-avalanche-v2-reserve-factor-adjustment/17040/2
 */
contract AaveV2Avalanche_ReserveFactorUpgrades_20240411 is IProposalGenericExecutor {
  ILendingPoolConfigurator public constant POOL_CONFIGURATOR =
    ILendingPoolConfigurator(AaveV2Avalanche.POOL_CONFIGURATOR);

  uint256 public constant DAIe_RF = 40_00;
  uint256 public constant USDCe_RF = 40_00;
  uint256 public constant USDTe_RF = 40_00;
  uint256 public constant WAVAX_RF = 40_00;
  uint256 public constant WBTCe_RF = 45_00;
  uint256 public constant WETHe_RF = 40_00;
