...
/**
 * @dev Test for AaveV2Avalanche_ReserveFactorUpgrades_20240411
 * command: make test-contract filter=AaveV2Avalanche_ReserveFactorUpgrades_20240411
 */
contract AaveV2Avalanche_ReserveFactorUpgrades_20240411_Test is ProtocolV2TestBase {
  AaveV2Avalanche_ReserveFactorUpgrades_20240411 internal proposal;
  ...
  function setUp() public {
    vm.createSelectFork(vm.rpcUrl('avalanche'), 44280713);
    proposal = new AaveV2Avalanche_ReserveFactorUpgrades_20240411();
  }
  ...
  function test_defaultProposalExecution() public {
    (ReserveConfig[] memory allConfigsBefore, ReserveConfig[] memory allConfigsAfter) = defaultTest(
      'AaveV2Avalanche_ReserveFactorUpgrades_20240411',
