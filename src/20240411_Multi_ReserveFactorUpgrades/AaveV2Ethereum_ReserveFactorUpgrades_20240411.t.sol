...
/**
 * @dev Test for AaveV2Ethereum_ReserveFactorUpgrades_20240411
 * command: make test-contract filter=AaveV2Ethereum_ReserveFactorUpgrades_20240411
 */
contract AaveV2Ethereum_ReserveFactorUpgrades_20240411_Test is ProtocolV2TestBase {
  AaveV2Ethereum_ReserveFactorUpgrades_20240411 internal proposal;
  ...
  function test_defaultProposalExecution() public {
    (ReserveConfig[] memory allConfigsBefore, ReserveConfig[] memory allConfigsAfter) = defaultTest(
      'AaveV2Ethereum_ReserveFactorUpgrades_20240411',
      AaveV2Ethereum.POOL,
      address(proposal)
    );
