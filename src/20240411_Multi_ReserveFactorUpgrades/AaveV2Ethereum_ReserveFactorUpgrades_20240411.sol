 ...
 */
contract AaveV2Ethereum_ReserveFactorUpgrades_20240411 is IProposalGenericExecutor {
  ILendingPoolConfigurator public constant POOL_CONFIGURATOR =
    ILendingPoolConfigurator(AaveV2Ethereum.POOL_CONFIGURATOR);

  uint256 public constant DAI_RF = 45_00;
  uint256 public constant FRAX_RF = 50_00;
  uint256 public constant GUSD_RF = 40_00;
  uint256 public constant LINK_RF = 50_00;
  uint256 public constant LUSD_RF = 45_00;
  uint256 public constant sUSD_RF = 50_00;
  uint256 public constant USDC_RF = 45_00;
  uint256 public constant USDP_RF = 40_00;
  uint256 public constant USDT_RF = 45_00;
  uint256 public constant WBTC_RF = 50_00;
  uint256 public constant WETH_RF = 45_00;
