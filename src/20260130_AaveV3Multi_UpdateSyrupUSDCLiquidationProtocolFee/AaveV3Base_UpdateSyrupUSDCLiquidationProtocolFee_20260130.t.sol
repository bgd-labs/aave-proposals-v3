 ...
 * command: FOUNDRY_PROFILE=test forge test --match-path=src/20260130_AaveV3Multi_UpdateSyrupUSDCLiquidationProtocolFee/AaveV3Base_UpdateSyrupUSDCLiquidationProtocolFee_20260130.t.sol -vv
 */
