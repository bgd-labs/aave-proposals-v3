...
/**
 * @dev Test for AaveV3Ethereum_OrbitRenewal_20251103
 * command: FOUNDRY_PROFILE=test forge test --match-path=src/20251103_AaveV3Ethereum_OrbitRenewal/AaveV3Ethereum_OrbitRenewal_20251103.t.sol -vv
 */
contract AaveV3Ethereum_OrbitRenewal_20251103_Test is ProtocolV3TestBase {
  AaveV3Ethereum_OrbitRenewal_20251103 internal proposal;

  function setUp() public {
    vm.createSelectFork(vm.rpcUrl('mainnet'), 20251103);
    proposal = new AaveV3Ethereum_OrbitRenewal_20251103();
  }
